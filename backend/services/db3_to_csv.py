...
def procesar_db_a_csv(
    ...
    if mask_only20.any():
        merged.loc[mask_only20, "CLASE_10"] = merged.loc[mask_only20, "CLASE_20"]
        merged.loc[mask_only20, "CONTADOR_10"] = merged.loc[mask_only20, "CONTADOR_20"]
        merged.loc[mask_only20, "CLASE_20"] = ""
        merged.loc[mask_only20, "CONTADOR_20"] = 0
