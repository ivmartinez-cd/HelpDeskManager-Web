...
function ToastItem({ toast, onDismiss }: { toast: Toast; onDismiss: () => void }) {
  ...
  return (
    <div
      className={`pointer-events-auto flex items-center gap-4 p-4 rounded-2xl border backdrop-blur-xl bg-white/10 dark:bg-black/40 shadow-2xl animate-slide-from-right ${borderColors[toast.type]}`}
    >
